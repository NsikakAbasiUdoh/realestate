import { Property, PropertyType, PropertyCategory, StateData, User, UserStatus } from './types';
...
export const NIGERIAN_STATES: StateData[] = [
  ...
  {
    name: "Ogun",
    lgas: ["Abeokuta North", "Abeokuta South", "Ado-Odo/Ota", "Ewekoro", "Ifo", "Ijebu East", "Ijebu North", "Ijebu North East", "Ijebu Ode", "Ikenne", "Imeko Afon", "Ipokia", "Obafemi Owode", "Odogbolu", "Odeda", "Ogun Waterside", "Remo North", "Shagamu", "Yewa North", "Yewa South"]
  },
  {
    name: "Ondo",
...
export const INITIAL_PROPERTIES: Property[] = [
  {
    ...
    description: 'A stunning newly built duplex with modern finishing, spacious compound, and excellent security. Located in a serene environment close to the city center.',
    price: 85000000,
    location: {
      state: 'Akwa Ibom',
      lga: 'Uyo',
      address: 'Shelter Afrique Estate'
    },
    features: ['4 Bedrooms', '5 Bathrooms', 'CCTV', 'Ample Parking', 'BQ'],
  ...
  {
    id: '2',
    title: '2 Plots of Dry Land',
    description: 'Two plots of dry, table land ready for immediate development. Perfect for a residential building or commercial plaza. Papers are intact.',
    price: 4500000,
    location: {
      state: 'Akwa Ibom',
      lga: 'Uyo',
      address: 'Near Okpokpo Market, Ikot Oku Ikono'
    },
    features: ['Dry Land', 'Survey Plan', 'Deed of Assignment', 'Fenced'],
    type: PropertyType.SALE,
    category: PropertyCategory.LAND,
    imageUrl: 'https://picsum.photos/seed/land1/800/600',
    dateAdded: Date.now() - 100000,
    contactPhone: '08068002159'
  },
  {
    id: '3',
    title: 'Luxury 2-Bedroom Apartment',
    description: 'Fully serviced apartment with 24/7 power supply, swimming pool, and gym access. Ideal for expatriates and working professionals.',
    price: 3500000,
    location: {
      state: 'Lagos',
      lga: 'Eti Osa',
      address: 'Phase 1, Admiralty Way, Lekki'
    },
  ...
  },
  {
    ...
    description: 'Large warehouse suitable for logistics, storage, or manufacturing. High ceilings and wide access gate for trucks.',
    price: 15000000,
    location: {
      state: 'Rivers',
      lga: 'Port Harcourt',
    ...
    features: ['1000sqm', 'High Ceiling', 'Truck Access', 'Office Space'],
    type: PropertyType.RENT,
    category: PropertyCategory.COMMERCIAL,
    imageUrl: 'https://picsum.photos/seed/warehouse/800/600',
...
export const INITIAL_USERS: User[] = [
  {
    id: 'u1',
    name: 'Emeka Okonkwo',
    businessName: 'Excel Properties Ltd',
    email: 'emeka@excelprops.com',
    phone: '08012345678',
    status: UserStatus.PENDING,
    dateRequested: Date.now() - 86400000 // 1 day ago
  },
  {
    id: 'u2',
    name: 'Aisha Bello',
    businessName: 'Northern Star Realty',
    email: 'aisha@nstar.com',
    phone: '09087654321',
    status: UserStatus.PENDING,
    dateRequested: Date.now() - 172800000 // 2 days ago
  },
  {
    id: 'u3',
    name: 'Tunde Bakare',
    businessName: 'Lagos Living',
    email: 'tunde@lagosliving.com',
    phone: '07055555555',
    status: UserStatus.APPROVED,
    dateRequested: Date.now() - 432000000 // 5 days ago
  }
];

export const CONTACT_INFO = {
  address: "Office 7-Upstairs Solid Star Plaza Opposite Okpokpo Market, Ikot Oku Ikono, Uyo, Akwa Ibom State",
  phones: ["09062712610", "08068002159"]
};